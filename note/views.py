...
def profilePage(request, pk):
    ...
    context = {'user': user, 'rooms': rooms, 'topics': topics,
               'rooms_count': rooms_count, 'customer_name': customer_name}
...
def createNote(request):
    ...
    context = {'topics': topics, 'form': form,
               'semesters': semesters, 'department': department}
...
def Catagories(request):
    ...
    context = {'departments': departments,
               'rooms_count': rooms_count, 'rooms': rooms}
...
def my_profile(request):
    ...
    context = {'shipping': shipping, 'customer': customer, 'items': items,
               'order': order, 'cart_items': cart_items, 'previous_orders': previous_orders}
