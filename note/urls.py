...
urlpatterns = [
    ...
    path('download_section/<str:pk>/',
         views.download_section, name="download_section"),
    ...
    path('customerorderdetail/<str:pk>',
         views.CustomerOrderDetail, name="customerorderdetail"),
    path('admin_orderitem/<str:pk>',
         views.admin_order_Item, name="admin_orderitem"),
